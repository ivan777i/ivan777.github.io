...
header('Access-Control-Allow-Headers: Overwrite, Destination, Content-Type, Depth, User-Agent, Translate, Range, Content-Range, Timeout, X-File-Size, X-Requested-With, If-Modified-Since, X-File-Name, Cache-Control, Location, Lock-Token, If, auth, logout');
header('Access-Control-Expose-Headers: DAV, content-length, Allow, auth, logout');
...
if($_SERVER['REQUEST_METHOD']=='OPTIONS') if(isset($_SERVER['HTTP_ACCESS_CONTROL_REQUEST_METHOD'])) $_SERVER['REQUEST_METHOD']=$_SERVER['HTTP_ACCESS_CONTROL_REQUEST_METHOD'];
/*
|--------------------------------------------------------------------------
| HTTP protocol
|--------------------------------------------------------------------------
